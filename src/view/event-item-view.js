...
function createEventItemTemplate(event) {
  ...
  return ` <li class="trip-events__item">
              <div class="event">
                <time class="event__date" datetime="2019-03-18">${humanizeDate(event.dateFrom)}</time>
                ...
                <div class="event__schedule">
                  <p class="event__time">
                    <time class="event__start-time" datetime="2019-03-18T12:25">${humanizeDateTime(event.dateFrom)}</time>
                    &mdash;
                    <time class="event__end-time" datetime="2019-03-18T13:35">${humanizeDateTime(event.dateTo)}</time>
                  </p>
                ...
                <ul class="event__selected-offers">
                  ${event.offers.length ? renderOffersList(event) : ''}
                </ul>
